...
const sections = [{
title: comienzo + ' 𝘼𝙪𝙩𝙤𝙢𝙖𝙩𝙞𝙘 𝙗𝙤𝙩 𝙧𝙚𝙢𝙤𝙫𝙚𝙧 ' + fin,
rows: [
...
{title: "│🔰│𝐈𝐍𝐒𝐓𝐀𝐋𝐀𝐑-𝘼𝙪𝙩𝙤𝙢𝙖𝙩𝙞𝙘 𝙗𝙤𝙩 𝙧𝙚𝙢𝙤𝙫𝙚𝙧", description: "INFORMACIÓN PARA INSTALAR A DORR∆T-BOT", rowId: `${usedPrefix}instalarbot`}
...
║ ⚡ ▢ ${uptime}
║┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
║ 💎 ▢ *Versión de 𝘼𝙪𝙩𝙤𝙢𝙖𝙩𝙞𝙘 𝙗𝙤𝙩 𝙧𝙚𝙢𝙤𝙫𝙚𝙧*
║ 💎 ▢ ${vs}
║ 🔳 ▢ Library:
║ 🖥️ ▢ ${library}
║┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
